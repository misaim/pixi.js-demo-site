...
{
  mainScene.addChild(circleScene);
  circleScene.addChild(circleOne);
  circleScene.addChild(circleTwo);
  circleScene.addChild(circleThree);
  circleScene.addChild(circleFour);
  circleScene.addChild(circleFive);
...
function randomCircle()
{
  ...
  drawPointX = randomSign() * randomInt(0, radi[currentCircle]);
  drawPointY = randomSign() * Math.sqrt((radi[currentCircle]*radi[currentCircle]) - (drawPointX*drawPointX));
}
